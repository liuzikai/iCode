...
Public Function iHookFunc(ByVal nCode As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    Case HCBT_MOVESIZE, HCBT_MINMAX
        ...
        iTipsBar.DealMessage nCode, wParam, sCaption, sClassName
        iCode.CWE.DealMessage nCode, wParam, sCaption, sClassName
    ...
    Case HCBT_SETFOCUS
        ...
        Case "VbaWindow"
            ...
            If sCaption = "对象浏览器" Or sCaption = "立即" Then Exit Function
            
            If hCodeWnd <> wParam Then
                '新的代码窗口
                iCode.CWE.DealMessage_NewCodePane
        ...
        Case "DockingView"
            ...
            If sCaption = "对象浏览器" Then
                
                WindowsControler.Msg wParam, sCaption
